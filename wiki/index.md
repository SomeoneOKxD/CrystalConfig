...
<div class="hero">
  <p><strong>CrystalConfig</strong> is a modern client-side config UI library for Minecraft mods. Use it when your mod needs polished config screens, persisted settings, searchable categories, user-created profiles, custom rows, theming, and Minecraft-specific controls such as a resource-pack-aware sound picker.</p>
</div>
